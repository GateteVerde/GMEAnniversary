...
//export double FMODInstanceSetSpeakerMix(double instance, double frontleft, double frontright, double center, double lfe, double backleft, double backright, double sideleft, double sideright)
